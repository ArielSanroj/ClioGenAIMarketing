...
def render_chat_interface():
    ...
    with col2:
        ...
        st.markdown(
            ...
            '<button class="save-exit-button">Save and Exit</button>'
            '</div>',
        ...
        st.markdown(
            ...
            '<button class="generate-button" onclick="generateContent()">Generate Content Marketing</button>'
            '<button class="campaign-button" onclick="createCampaign()">Create Marketing Campaign</button>'
            '</div>',
            unsafe_allow_html=True
        )
